package com.learning.springboot.cache;

import com.learning.springboot.dto.TagDTO;
...
public class TagCache {
    public static List<TagDTO> getTags(){
        ...
        program.setTags(Arrays.asList("javascript","php","css","html","html5","java","node.js","python","c++","c","golang",
                "objective-c","typescript","shell","c#","swift","sass","bash","ruby","less","asp.net","lua","scala",
        ...
        database.setTags(Arrays.asList("mysql","redis","mongodb","sql","oracle","nosql","memcached","sqlserver",
                "postgresql","sqlite"));
        tagDTOs.add(database);

        TagDTO devtool = new TagDTO();
        devtool.setCategoryName("开发工具");
        devtool.setTags(Arrays.asList("git","github","visual-studio-code","vim","sublime-text","xcode","intellij-idea",
